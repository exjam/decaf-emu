...
template <typename QueueType, typename LinkType, typename ItemType, be2_struct<LinkType> ItemType::*LinkField, bool IsLess(virt_ptr<ItemType>, virt_ptr<ItemType>)>
