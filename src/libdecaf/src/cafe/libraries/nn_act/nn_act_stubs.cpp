...
void
Library::registerStubSymbols()
{
   RegisterFunctionExportName("Initialize__Q2_2nn3actFv", nn::act::Initialize);
   RegisterFunctionExportName("Finalize__Q2_2nn3actFv", nn::act::Finalize);
   RegisterFunctionExportName("Cancel__Q2_2nn3actFv", nn::act::Cancel);
   RegisterFunctionExportName("IsSlotOccupied__Q2_2nn3actFUc", nn::act::IsSlotOccupied);
   RegisterFunctionExportName("GetSlotNo__Q2_2nn3actFv", nn::act::GetSlotNo);
   RegisterFunctionExportName("GetMii__Q2_2nn3actFP12FFLStoreData", nn::act::GetMii);
   RegisterFunctionExportName("GetMiiEx__Q2_2nn3actFP12FFLStoreDataUc", nn::act::GetMiiEx);
   RegisterFunctionExportName("GetMiiName__Q2_2nn3actFPw", nn::act::GetMiiName);
   RegisterFunctionExportName("GetMiiNameEx__Q2_2nn3actFPwUc", nn::act::GetMiiNameEx);
   RegisterFunctionExportName("IsParentalControlCheckEnabled__Q2_2nn3actFv", nn::act::IsParentalControlCheckEnabled);
   RegisterFunctionExportName("IsNetworkAccount__Q2_2nn3actFv", nn::act::IsNetworkAccount);
   RegisterFunctionExportName("IsNetworkAccountEx__Q2_2nn3actFUc", nn::act::IsNetworkAccountEx);
   RegisterFunctionExportName("GetNumOfAccounts__Q2_2nn3actFv", nn::act::GetNumOfAccounts);
   RegisterFunctionExportName("GetUuid__Q2_2nn3actFP7ACTUuid", nn::act::GetUuid);
   RegisterFunctionExportName("GetUuidEx__Q2_2nn3actFP7ACTUuidUc", nn::act::GetUuidEx);
   RegisterFunctionExportName("GetAccountId__Q2_2nn3actFPc", nn::act::GetAccountId);
   RegisterFunctionExportName("GetAccountIdEx__Q2_2nn3actFPcUc", nn::act::GetAccountIdEx);
   RegisterFunctionExportName("GetParentalControlSlotNo__Q2_2nn3actFv", nn::act::GetParentalControlSlotNo);
   RegisterFunctionExportName("GetParentalControlSlotNoEx__Q2_2nn3actFPUcUc", nn::act::GetParentalControlSlotNoEx);
   RegisterFunctionExportName("GetPersistentId__Q2_2nn3actFv", nn::act::GetPersistentId);
   RegisterFunctionExportName("GetPersistentIdEx__Q2_2nn3actFUc", nn::act::GetPersistentIdEx);
   RegisterFunctionExportName("GetPrincipalId__Q2_2nn3actFv", nn::act::GetPrincipalId);
   RegisterFunctionExportName("GetPrincipalIdEx__Q2_2nn3actFPUiUc", nn::act::GetPrincipalIdEx);
   RegisterFunctionExportName("GetSimpleAddressId__Q2_2nn3actFv", nn::act::GetSimpleAddressId);
   RegisterFunctionExportName("GetSimpleAddressIdEx__Q2_2nn3actFPUiUc", nn::act::GetSimpleAddressIdEx);
   RegisterFunctionExportName("GetTransferableId__Q2_2nn3actFUi", nn::act::GetTransferableId);
   RegisterFunctionExportName("GetTransferableIdEx__Q2_2nn3actFPULUiUc", nn::act::GetTransferableIdEx);
   RegisterFunctionExportName("GetDeviceHash__Q2_2nn3actFPUL", nn::act::GetDeviceHash);
   RegisterFunctionExportName("IsCommittedEx__Q2_2nn3actFUc", nn::act::IsCommittedEx);
}
