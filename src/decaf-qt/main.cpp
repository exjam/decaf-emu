                     ...
                     void* pUserData)
{
   ...
   if (!isKnownIssue) {
      ...
      qDebug("Vulkan Debug Report (Known Case): {}", pMessage);
   }
...
int main(int argc, char *argv[])
{
   ...
   DecafSDLSound soundDriver { };
   DecafInterface decafInterface { &inputDriver, &soundDriver };

   MainWindow mainWindow(&inst, &decafInterface, &inputDriver);
