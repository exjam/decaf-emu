...
{
   mRenderer = new VulkanRenderer(this, mDecafInterface);
   return mRenderer;
}
...
void VulkanRenderer::keyPressEvent(QKeyEvent *ev)
{
   ...
   mDebugUi->onKeyAction(translateKeyCode(ev), debugui::KeyboardAction::Press);
...
void VulkanRenderer::keyReleaseEvent(QKeyEvent *ev)
{
   ...
   mDebugUi->onKeyAction(translateKeyCode(ev), debugui::KeyboardAction::Release);
}
...
void VulkanRenderer::mousePressEvent(QMouseEvent *ev)
{
   ...
   mDebugUi->onMouseAction(button, debugui::MouseAction::Press);
}
...
void VulkanRenderer::mouseReleaseEvent(QMouseEvent *ev)
{
   ...
   mDebugUi->onMouseAction(button, debugui::MouseAction::Release);
}
...
void VulkanRenderer::mouseMoveEvent(QMouseEvent *ev)
{
   ...
   auto pos = ev->pos();
   mDebugUi->onMouseMove(static_cast<float>(pos.x()), static_cast<float>(pos.y()));
}
...
void VulkanRenderer::wheelEvent(QWheelEvent *ev)
{
   ...
   mDebugUi->onMouseScroll(delta.x() / 120.0f, delta.y() / 120.0f);
}
